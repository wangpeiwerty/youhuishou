...
public class EditDialog extends BaseAlertDialog<EditDialog> {
    ...
    boolean isNumber;
    String message;
    public EditDialog(Context context,String message,boolean isNumber) {
        super(context);
    ...
    /** set style(设置style) */
    public EditDialog style(int style) {
        this.mStyle = style;
        return this;
    }

    /** set title underline color(设置标题下划线颜色) */
    public EditDialog titleLineColor(int titleLineColor) {
        this.mTitleLineColor = titleLineColor;
        return this;
    }

    /** set title underline color(设置edittext输入类型) */
    public EditDialog inputType(int inputType) {
        editText.setInputType(inputType);
        return this;
    }

    /** set title underline height(设置标题下划线高度) */
    public EditDialog titleLineHeight(float titleLineHeight_DP) {
        this.mTitleLineHeight = titleLineHeight_DP;
        return this;
    }

    /** set divider color between btns(设置btn分割线的颜色) */
    public EditDialog dividerColor(int dividerColor) {
