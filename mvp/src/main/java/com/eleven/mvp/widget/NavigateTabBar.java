...
public class NavigateTabBar extends LinearLayout implements View.OnClickListener {
    ...
    public NavigateTabBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mNormalTextColor = (tabTextColor != null ? tabTextColor : context.getResources().getColorStateList(R.color.text_gray_color));
...
//            showFragment(holder);
    ...
    public Fragment getCurrentFragment(){
        return mFragmentActivity.getSupportFragmentManager().findFragmentByTag(mCurrentTag);
    }
}
